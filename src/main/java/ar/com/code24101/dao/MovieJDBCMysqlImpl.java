...
public class MovieJDBCMysqlImpl implements MovieDAO{
    ...
    public Movie getById(Long id) {
        ...
        try{
            ...
            if(resultset.next()) {
                Long idMovie = resultset.getLong(1);
                ...
                movie = new Movie(idMovie, nombre, apellido, email, imagen, tipoClienteID);
            }
        }catch(Exception e) {
    ...
    public void create(Movie movieDto) {
        String sql = "INSERT INTO clientes (nombre, apellido, email, imagen, tipoClienteID) values(?,?,?,?,?)";
        ...
        try {
            ...
            if(pst.getUpdateCount() > 0) {
                System.out.println("Movie agregada correctamente");
            }
        }catch(Exception e) {
            e.printStackTrace();
        }finally {
    ...
    public ArrayList<Movie> findAll() {
        ...
        try{
            ...
            while(resultset.next()) {
                ...
                Movie unaPelicula = new Movie(id, nombre, apellido, imagen, email, tipoClienteID);
    ...
    public void update(Movie movie) {           
        ...
        String sql = "UPDATE clientes set nombre=?, apellido=?, email=?, imagen=?, tipoClienteID=? WHERE id=?";
